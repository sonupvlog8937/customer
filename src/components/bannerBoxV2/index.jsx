        ...
        <div className="w-full">
          {
            props?.item?.subCatId !== undefined && props?.item?.subCatId !== null ?
              <Link to={`/products?subCatId=${props?.item?.subCatId}`} className="text-[16px] text-primary bg-red-600 p-2 font-[600] link">SHOP NOW</Link>
              :

              <Link to={`/products?catId=${props?.item?.catId}`} className="text-[16px] text-primary bg-red-600 p-2 font-[600] link">SHOP NOW</Link>
